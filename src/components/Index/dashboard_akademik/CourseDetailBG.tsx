...
const coursesData: { category: string; courses: Course[] }[] = [
  ...
  },
  {
    ...
    courses: [
      {
        id: 5,
        name: "Pengolahan Makanan Kontinental",
        meetings: 18,
        duration: 90,
      },
      {
        id: 6,
        name: "Pengolahan Makanan Indonesia",
        meetings: 16,
        duration: 80,
      },
      { id: 7, name: "Pastry dan Bakery", meetings: 14, duration: 70 },
    ],
  },
];

const CourseDetailBG = () => {
