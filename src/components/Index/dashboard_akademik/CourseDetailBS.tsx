...
const coursesData: { category: string; courses: Course[] }[] = [
  ...
  },
  {
    ...
    courses: [
      { id: 5, name: "Dasar Desain", meetings: 18, duration: 90 },
      { id: 6, name: "Pola Busana", meetings: 16, duration: 80 },
      { id: 7, name: "Teknik Menjahit", meetings: 14, duration: 70 },
    ],
  },
];

const CourseDetailBS = () => {
