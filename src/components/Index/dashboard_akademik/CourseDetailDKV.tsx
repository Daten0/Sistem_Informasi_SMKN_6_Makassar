...
const coursesData: { category: string; courses: Course[] }[] = [
  ...
  },
  {
    ...
    courses: [
      { id: 5, name: "Desain Grafis", meetings: 18, duration: 90 },
      { id: 6, name: "Multimedia", meetings: 16, duration: 80 },
      { id: 7, name: "Animasi", meetings: 14, duration: 70 },
    ],
  },
];

const CourseDetailDKV = () => {
...
export default CourseDetailDKV;
