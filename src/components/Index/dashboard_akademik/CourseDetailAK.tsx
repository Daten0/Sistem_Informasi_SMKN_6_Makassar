...
const coursesData: { category: string; courses: Course[] }[] = [
  ...
  },
  {
    ...
    courses: [
      { id: 5, name: "Akuntansi Dasar", meetings: 18, duration: 90 },
      { id: 6, name: "Perpajakan", meetings: 16, duration: 80 },
      { id: 7, name: "Komputer Akuntansi", meetings: 14, duration: 70 },
    ],
  },
];

const CourseDetailAK = () => {
