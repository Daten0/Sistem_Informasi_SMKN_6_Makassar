...
import { SearchBar } from "@/components/Index/dashboard_akademik/SearchBar";
import {
  Table,
  TableBody,
  TableCell,
...
const coursesData: { category: string; courses: Course[] }[] = [
  ...
  },
  {
    ...
    courses: [
      { id: 5, name: "Front Office", meetings: 18, duration: 90 },
      { id: 6, name: "Housekeeping", meetings: 16, duration: 80 },
      { id: 7, name: "Food & Beverage Service", meetings: 14, duration: 70 },
    ],
  },
];

const CourseDetailPH = () => {
